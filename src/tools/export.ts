...
// =============================================================================
// SKR03 KONTEN-MAPPING (German Standard Chart of Accounts)
// =============================================================================
...
export async function exportInvoices(args: Record<string, unknown>): Promise<unknown> {
  ...
  if (status !== 'all') {
    where.status = status as 'draft' | 'sent' | 'paid';
  }
...
// =============================================================================
// TAX ADVISOR EXPORT (STEUERBERATER-EXPORT)
// =============================================================================
...
// -----------------------------------------------------------------------------
// CSV Export (Readable format for tax advisors)
// -----------------------------------------------------------------------------
...
function taxExportToEnhancedCSV(
  ...
  // ==========================================================================
  // SECTION 1: ZUSAMMENFASSUNG (GEWINNERMITTLUNG)
  // ==========================================================================
  lines.push('# ───────────────────────────────────────────────────────────────────────────────');
  ...
  // ==========================================================================
  // SECTION 2: EÜR-ZEILEN ZUORDNUNG
  // ==========================================================================
  lines.push('# ───────────────────────────────────────────────────────────────────────────────');
...
// -----------------------------------------------------------------------------
// DATEV Export (DATEV-compatible format)
// -----------------------------------------------------------------------------
...
function taxExportToDATEV(
  ...
  // Column headers (DATEV Buchungsstapel minimal columns)
  lines.push(
...
export async function exportForTaxAdvisor(args: Record<string, unknown>): Promise<unknown> {
  ...
  const enhancedTransactions: EnhancedTransaction[] = transactions.map((tx, idx) => {
    ...
    return {
      ...
      projekt: (tx as unknown as { project?: { name: string } }).project?.name || null,
      konto,
    };
  });
