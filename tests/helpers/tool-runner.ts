/**
 * Tool Runner - Helper for directly invoking MCP tools in tests
 *
 * This module provides a way to call tool handlers directly without going
 * through the full MCP protocol, making integration tests faster and more direct.
 */
...
/**
 * Map of all available tool handlers
 */
 ...
 * @throws If the tool is unknown or the tool throws an error
 */
...
/**
 * Type-safe tool runners for common operations
 */
export const tools = {
  // Transactions
  addIncome: (args: {
